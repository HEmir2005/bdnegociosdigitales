...
-- Seleccionar la cantidad m�xima vendida por producto en cada pedido
...
/*
	Flujo l�gico de ejecuci�n de SQL
	1. FROM
	2. JOIN
	3. WHERE
	4. GROUP BY
...
-- Seleccionar los clientes que hayan realizado m�s de 10 pedidos+
...
-- Seleccionar el precio m�ximo de productos por categoria, pero solo si la suma de unidades es menor a 200
